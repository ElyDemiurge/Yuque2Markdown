...
Cyberangel 全程使用 Claude 进行 Vibe Coding。
...
A: 语雀 API 存在请求频率限制。程序会自动等待并重试，但如果频繁触发，建议适当增加“请求间隔”设置，例如 `0.5` 秒或更高。

**Q: 图片或附件下载失败？**

A: 先检查网络和代理设置，再查看 `output/.../export.log` 中对应文档的资源下载错误。更详细的定位方法见 [docs/TROUBLESHOOTING.md](docs/TROUBLESHOOTING.md)。
